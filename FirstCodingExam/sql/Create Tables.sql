...
-- CREATE RECORDS CALCULATED HISTORY TABLE
IF (NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_CATALOG = @ApplicationDatabaseName AND TABLE_NAME = 'HistoryCalculatedRecords'))
BEGIN
	CREATE TABLE HistoryCalculatedRecords (
		Id INT PRIMARY KEY IDENTITY,
		HistoryRecordId INT FOREIGN KEY REFERENCES HistoryRecords(Id) DEFAULT NULL,
		Years INT NOT NULL,
		CurrentAmount FLOAT NOT NULL,
		InterestRate INT NOT NULL,
		FutureAmount FLOAT NOT NULL,
